...
if($error == ''){
    ...
    curl_setopt_array($curl, array(
      ...
      CURLOPT_HTTPHEADER => array(
        ...
        "Authorization: Bearer deb7ac09f10d134b50e835896e57f9a3b39daedd" //Api SUN chequeado
...
header("Location: https://ar-promo.unileverservices.com/sun-argentina-exito/");
