...
$codigolata = $_GET["codigolata"];
$codigolata = filter_var($codigolata, FILTER_SANITIZE_STRING);
$codigolata = trim($codigolata);
...
echo "Codigo (no va a bunker)".$codigolata. "<br>";
echo "<br>";

echo "es mayor de 18:" .$mayor_18_anos. "<br>";
...
if($error == ''){
    ...
    curl_setopt_array($curl, array(
      ...
      CURLOPT_HTTPHEADER => array(
        ...
        "Authorization: Bearer 942d8139fada6fd3871617648e4c18de84c4a553" //Api axe y sedal al lolla joya!
...
header("Location: https://ar-promo.unileverservices.com/axe-y-sedal-lollapalooza-exito");
